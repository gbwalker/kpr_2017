...
As a first attempt, I use the "bag-of-words" approach where word order within each post does not matter. An alterntaive approach would be to use a "bigram" that counts frequencies of adjacent pairs of words.
